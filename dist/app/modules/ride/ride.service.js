...
const getAllDriverPosts = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const driverData = queryBuilder
        .filter()
        .search(rideConstant_1.riderSearchableFields)
        .sort()
        .fields()
        .pagination();
...
const updatePostStatus = (postId, postStatus) => __awaiter(void 0, void 0, void 0, function* () {
    const validStatuses = Object.values(ride_interface_1.IRiderPostStatus);
    ...
    const updatedPost = yield ride_model_1.Rider.findByIdAndUpdate(postId, { postStatus: postStatus.toUpperCase() }, { new: true });
    if (!updatedPost) {
